...
PICS = (environ.get('PICS', 'https://envs.sh/eIV.jpeg https://envs.sh/enD.jpeg https://envs.sh/enE.jpeg ')).split() #SAMPLE PIC
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'http://techvjlink.site')
SHORTLINK_API = environ.get('SHORTLINK_API', 'cf28791d8f9477119977add9a7232aab97e5d09a')
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = environ.get('Tamil Anime')
else:
    ON_HEROKU = False
